...
describe('IPS Tests', function () {
  ...
  describe('ips_OptInService Tests', function () {
    ...
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedIPSClass.ips_OptInService(CIM_Methods.RequestPowerStateChange, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
  describe('ips_HostBasedSetupService Tests', function () {
    ...
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedIPSClass.ips_HostBasedSetupService(CIM_Methods.RequestPowerStateChange, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
})
