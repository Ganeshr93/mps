...
describe('AMT Tests', () => {
  ...
  describe('amt_AuditLog Tests', () => {
    it('should return a valid amt_AuditLog ReadRecords wsman message', () => {
      ...
      const response = amtClass.amt_AuditLog(AMT_Methods.ReadRecords, messageId, 1)
  ...
  describe('amt_SetupAndConfigurationService Tests', () => {
    ...
    it('should return a valid amt_SetupAndConfigurationService Unprovision wsman message', () => {
      const correctResponse = `<?xml version="1.0" encoding="utf-8"?><Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:a="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns:w="http://schemas.dmtf.org/wbem/wsman/1/wsman.xsd" xmlns="http://www.w3.org/2003/05/soap-envelope"><Header><a:Action>http://intel.com/wbem/wscim/1/amt-schema/1/AMT_SetupAndConfigurationService/Unprovision</a:Action><a:To>/wsman</a:To><w:ResourceURI>http://intel.com/wbem/wscim/1/amt-schema/1/AMT_SetupAndConfigurationService</w:ResourceURI><a:MessageID>${messageId}</a:MessageID><a:ReplyTo><a:Address>http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous</a:Address></a:ReplyTo><w:OperationTimeout>${operationTimeout}</w:OperationTimeout></Header><Body><r:Unprovision_INPUT xmlns:r="http://intel.com/wbem/wscim/1/amt-schema/1/AMT_SetupAndConfigurationService"><r:ProvisioningMode>2</r:ProvisioningMode></r:Unprovision_INPUT></Body></Envelope>`
      const response = amtClass.amt_SetupAndConfigurationService(AMT_Methods.Unprovision, messageId)
      expect(response).toEqual(correctResponse)
    })
  })
  ...
  describe('amt_EthernetPortSettings Tests', () => {
    ...
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedAMTClass.amt_EthernetPortSettings(CIM_Methods.SetBootConfigRole, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
  describe('amt_RemoteAccessPolicyRule Tests', () => {
    it('should create a valid amt_RemoteAccessPolicyRule Delete wsman message', () => {
      const policyRuleName = 'User Initiated'
      ...
      const response = amtClass.amt_RemoteAccessPolicyRule(CIM_Methods.Delete, messageId, policyRuleName)
      expect(response).toEqual(correctResponse)
    })
    it('should throw error if policyRuleName is missing from amt_RemoteAccessPolicyRule Delete method', () => {
      expect(() => { amtClass.amt_RemoteAccessPolicyRule(CIM_Methods.Delete, messageId, null) }).toThrow(WSManErrors.POLICY_RULE_NAME)
    })
  })
  ...
  describe('amt_EnvironmentDetectionSettingData Tests', () => {
    ...
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedAMTClass.amt_EnvironmentDetectionSettingData(CIM_Methods.SetBootConfigRole, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
  describe('amt_PublicKeyManagementService Tests', () => {
    it('should return a valid amt_PublicKeyManagementService AddTrustedRootCertificate wsman message', () => {
      ...
      const response = amtClass.amt_PublicKeyManagementService(AMT_Methods.AddTrustedRootCertificate, messageId, trustedRootCert)
      expect(response).toEqual(correctResponse)
    })
    it('should throw error if certificateBlob is missing from amt_PublicKeyManagementService methods', () => {
      expect(() => { amtClass.amt_PublicKeyManagementService(AMT_Methods.AddTrustedRootCertificate, messageId) }).toThrow(WSManErrors.CERTIFICATE_BLOB)
    })
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedAMTClass.amt_PublicKeyManagementService(CIM_Methods.SetBootConfigRole, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
  describe('amt_RemoteAccessService Tests', () => {
    ...
    it('should return a valid amt_RemoteAccessService addMpsServer wsman message', () => {
      ...
      const response = amtClass.amt_RemoteAccessService(AMT_Methods.AddMpServer, messageId, mpsServer)
      expect(response).toEqual(correctResponse)
    })
    it('should return a valid amt_RemoteAccessService AddRemoteAccessPolicyRule wsman message', () => {
      ...
      const response = amtClass.amt_RemoteAccessService(AMT_Methods.AddRemoteAccessPolicyRule, messageId, null, remoteAccessPolicyRule, selector.value)
      expect(response).toEqual(correctResponse)
    })
    it('should throw error if mpServer is missing from amt_RemoteAccessService AddMpServer methods', () => {
      expect(() => { amtClass.amt_RemoteAccessService(AMT_Methods.AddMpServer, messageId) }).toThrow(WSManErrors.MP_SERVER)
    })
    it('should throw error if remoteAccessPolicyRule is missing from amt_RemoteAccessService AddRemoteAccessPolicyRule methods', () => {
      const selector: Selector = { name: 'Name', value: 'Intel(r) AMT:Management Presence Server 0' }
      expect(() => { amtClass.amt_RemoteAccessService(AMT_Methods.AddRemoteAccessPolicyRule, messageId, null, null, selector.value) }).toThrow(WSManErrors.REMOTE_ACCESS_POLICY_RULE)
    })
    it('should throw error if policyRuleName is missing from amt_RemoteAccessService AddRemoteAccessPolicyRule methods', () => {
      expect(() => { amtClass.amt_RemoteAccessService(AMT_Methods.AddRemoteAccessPolicyRule, messageId, null, remoteAccessPolicyRule) }).toThrow(WSManErrors.POLICY_RULE_NAME)
    })
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedAMTClass.amt_RemoteAccessService(CIM_Methods.SetBootConfigRole, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
  describe('amt_UserInitiatedConnectionService Tests', () => {
    it('should return a valid amt_UserInitiatedConnectionService AddTrustedRootCertificate wsman message', () => {
      ...
      const response = amtClass.amt_UserInitiatedConnectionService(AMT_Methods.RequestStateChange, messageId, requestedState)
      expect(response).toEqual(correctResponse)
    })
    it('should throw error if requestedState is missing from amt_UserInitiatedConnectionService RequestStateChange methods', () => {
      expect(() => { amtClass.amt_UserInitiatedConnectionService(AMT_Methods.RequestStateChange, messageId, null) }).toThrow(WSManErrors.REQUESTED_STATE)
    })
  })
  describe('amt_BootSettingData Tests', () => {
    ...
    it('should throw error if an unsupported method is called', () => {
      expect(() => { castedAMTClass.amt_BootSettingData(CIM_Methods.SetBootConfigRole, messageId) }).toThrow(WSManErrors.UNSUPPORTED_METHOD)
    })
  })
})
