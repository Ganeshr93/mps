...
it('should set 404 and not delete device if it does not exist in db', async () => {
...
it('should set 204 and delete device if it exists in db', async () => {
...
it('should set 500 and not delete device if error occurs', async () => {
